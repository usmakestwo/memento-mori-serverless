class TemplateBuilder:
  def init_readme(self, name = "Sample"):
    text_file = open('./utils/files/init-readme.txt', 'r')
  ...
  def init_resource_readme(self, name = "Sample"):
    text_file = open('./utils/files/init-resources.txt', 'r')
  ...
  def init_courses_readme(self, name = "Sample"):
    text_file = open('./utils/files/init-courses.txt', 'r')
  ...
  def init_praxi(self, git_name, name, description):
    text_file = open('./utils/files/praxi.txt', 'r')
